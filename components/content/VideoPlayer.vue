<template>
  <div class="video-player relative my-4 bg-black bg-opacity-25 rounded-lg" :class="{ loaded }">
    <img
      v-if="provider ? provider.poster : poster"
      class="video my-0 py-0 absolute top-0 left-0 w-full h-full object-cover"
    ...
    <div v-if="loaded" class="video absolute top-0 left-0 w-full h-full">
      <!-- remote videos -->
      <video v-if="!provider" class="my-0" :poster="poster" controls autoplay>
